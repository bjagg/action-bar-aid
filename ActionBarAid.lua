...
function ActionBarAid.buildSpellSourceMap()
  ...
  -- 1. Hero talents
  local heroTrees = C_ClassTalents.GetHeroTalentTreeIDs()
  for _, treeID in ipairs(heroTrees or {}) do
    for _, nodeID in ipairs(C_ClassTalents.GetHeroTalentNodes(treeID) or {}) do
